    ...
    <nav className="bg-bg text-white p-2 fixed w-full z-50">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden lg:flex space-x-10 mr-8 text-1xl font-semibold">
          ...
          <Link to="/My-Portfolio-V2/projects" className="hover:text-primary transition-colors duration-300">PROJECTS</Link>
          <Link to="/My-Portfolio-V2/contacts" className="hover:text-primary transition-colors duration-300">CONTACTS</Link>
        </div>
      ...
      <div className={`${isOpen ? "block" : "hidden"} md:hidden bg-bg`}>
        <div className="flex flex-col items-center space-y-5 py-5">
          ...
          <Link to="/My-Portfolio-V2/skills" onClick={toggleMenu} className="hover:text-primary transition-colors duration-300">SKILLS</Link>
          <Link to="/My-Portfolio-V2/services" onClick={toggleMenu} className="hover:text-primary transition-colors duration-300">SERVICES</Link>
          <Link to="/My-Portfolio-V2/projects" onClick={toggleMenu} className="hover:text-primary transition-colors duration-300">PROJECTS</Link>
          <Link to="/My-Portfolio-V2/contacts" onClick={toggleMenu} className="hover:text-primary transition-colors duration-300">CONTACTS</Link>
        </div>
      </div>
    </nav>
  );
