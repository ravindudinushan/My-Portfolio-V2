    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-darkBlue text-white p-4 sm:p-8 lg:pt-24 lg:pb-24 pt-16">
            <div className="max-w-4xl text-center space-y-8">
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-green mb-4">My Services</h1>
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 sm:gap-8 mt-6 sm:mt-8">
                    <div className="service-item p-4 sm:p-6 rounded-lg shadow-lg border border-green hover:scale-105 transition-transform 
                    duration-300">
