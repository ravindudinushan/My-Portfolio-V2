    ...
    return (
        <div className="flex flex-col min-h-screen bg-darkBlue text-white pb-24 items-center justify-center">
            <div className="flex-grow max-w-4xl text-center space-y-8 pt-20 md:pt-24">
                <h1 className="text-3xl md:text-5xl font-extrabold text-green">Contact Me</h1>
                ...
                <form className="bg-darkBlue p-4 md:p-6 rounded-lg shadow-lg">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="name" name="name" className="w-full p-2 rounded-lg bg-gray-800 border border-green 
                        ...
                        <div>
                            ...
                            border-green text-white placeholder-gray-400" placeholder="Your Email" required />
                        </div>
                    </div>
                    <div className="mt-4">
                        ...
                        border-green text-white placeholder-gray-400" placeholder="Your Message" required></textarea>
                    </div>
                    <button type="submit" className="mt-4 bg-green text-darkBlue px-4 md:px-6 py-2 md:py-3 rounded-lg 
                ...
                <div className="mt-8">
                    ...
                    <div className="flex justify-center space-x-4 md:space-x-6">
                        <a href="https://www.linkedin.com/in/ravindu-dinushan-60709227b/" target="_blank" rel="noopener noreferrer"
                            className="text-green hover:scale-105 transition duration-300 text-lg">
