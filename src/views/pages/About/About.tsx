    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-darkBlue text-white p-4 sm:p-8">
            <div className="max-w-2xl sm:max-w-4xl text-center space-y-6">
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-green">About Me</h1>
                ...
                <a href="/My-Portfolio-V2/projects" className="inline-block bg-green text-darkBlue px-6 py-3 rounded-lg font-semibold 
